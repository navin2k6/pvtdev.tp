...
namespace Arcmatics.Security
{
    public class Cryptography
    {
        ...
        {
            encryptText = encryptText.Replace("@", "[at]").Replace(".","[dot]");
            ...
            using (Aes encryptor = Aes.Create())
            {
                ...
                using (MemoryStream ms = new MemoryStream())
                {
                    ...
                    encryptText = encryptText.Replace('+', '-').Replace("/", "t47p").Replace("=", "t61p");
                }
            }
        ...
        {
            encrytedText = encrytedText.Replace('-', '+').Replace("t47p", "/").Replace("t61p", "=");
            ...
            encrytedText = encrytedText.Replace("[at]", "@").Replace("[dot]", ".");
