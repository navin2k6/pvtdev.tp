    ...
    public class DashboardController : Controller
    {
                                          ...
                                          string functionalArea, string category, string sector, string profile)
        {
            ...
            try
            {
                ...
                // Save data:
                IOrganization org = new Organization(HttpContext.Request.Cookies["talentsprofile_user"]);
                if (org.AddOrganization(string.Empty, string.Empty, name, address, city, countryId, uri, logoUri, functionalAreaId, category, sector, profile))
